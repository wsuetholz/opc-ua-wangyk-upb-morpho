...
As described in previous sections, my demonstration system consists of two main parts, namely the on card integrated  communication stack and android application.
...
Communication stack includes following classes:
 ...
 \item  \emph{ApduTransfer}, which is in charge of processing incoming APDUs and transmitting output APDUs. This class also provides methods that are necessary for cryptographic operations.
\end{itemize}
...
\begin{itemize}
  ...
  \item Encrypt Message APDU sets
  \item Decrypt Message APDU sets
  \item Signature APDU sets
  \item Process Data APDU sets
\end{itemize}
\end{itemize}
...
\hline
CLA  & INS  & P1   & P2   & Lc   & Data field                                                                                          & Le  \\ \hline
0xA0 & 0x10 & 0x00 & 0x00 & N/A & N/A & N/A \\ \hline
\end{tabular}
}
...
Optional data & Status word & Description                                \\ \hline
No data       & 0x9000      & Successful processing                      \\ \hline
              & 0x6300      & Verification failed \\ \hline               
\end{tabular}
}
\end{table}
...
\hline
CLA  & INS  & P1   & P2   & Lc   & Data field                                                                                          & Le  \\ \hline
0xA0 & 0x40 & 0x00 & 0x00 & 0x00 & N/A& N/A \\ \hline
\end{tabular}
}
