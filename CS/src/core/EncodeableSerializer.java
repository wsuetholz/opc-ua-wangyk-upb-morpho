...
import encoding.binary.DecoderUtils;
...
import encoding.utils.AbstractSerializer;
import core.ObjectNode;
...
public class EncodeableSerializer extends SerializerComposition {
	...
	public EncodeableSerializer() {
    	...
    	// EnumValueInfo
    	addSerializer(
    		new AbstractSerializer(EnumValueInfo.class, EnumValueInfo.BINARY, EnumValueInfo.XML) {
    			public void calcEncodeable(IEncodeable encodeable, IEncoder calculator) throws EncodingException {
    				EnumValueInfo obj = (EnumValueInfo) encodeable;
    				calculator.putLocalizedText(null,  (obj==null)?null:obj.getName() );
    				calculator.putInt32(null, null /*obj.getValue()*/);
    			}
    			public void putEncodeable(IEncodeable encodeable, IEncoder encoder) throws EncodingException {
    				EnumValueInfo obj = (EnumValueInfo) encodeable;
    				encoder.putLocalizedText("Name",  (obj==null)?null:obj.getName() );
    				encoder.putInt32("Value",  (obj==null)?null:obj.getValue() );
    			}
    			public IEncodeable getEncodeable(IDecoder decoder) throws DecodingException {
    				EnumValueInfo result = new EnumValueInfo();
    				result.setName( decoder.getLocalizedText("Name") );
    				result.setValue( decoder.getInt32("Value") );
    				return result;
    			}
    		});
    	...
    	addSerializer(
    		new AbstractSerializer(ReadProcessedDetails.class, ReadProcessedDetails.BINARY, ReadProcessedDetails.XML) {
    			public void calcEncodeable(IEncodeable encodeable, IEncoder calculator) throws EncodingException {
    				...
    				calculator.putDateTime(null,  (obj==null)?null:obj.getStartTime() );
    				calculator.putDateTime(null,  (obj==null)?null:obj.getEndTime() );
    				calculator.putDouble(null, null /*obj.getResampleInterval()*/);
    			...
    			public void putEncodeable(IEncodeable encodeable, IEncoder encoder) throws EncodingException {
    				...
    				encoder.putDateTime("StartTime",  (obj==null)?null:obj.getStartTime() );
    				encoder.putDateTime("EndTime",  (obj==null)?null:obj.getEndTime() );
    				encoder.putDouble("ResampleInterval",  (obj==null)?null:obj.getResampleInterval() );
    			...
    			public IEncodeable getEncodeable(IDecoder decoder) throws DecodingException {
    				...
    				result.setStartTime( decoder.getDateTime("StartTime") );
    				result.setEndTime( decoder.getDateTime("EndTime") );
    				result.setResampleInterval( decoder.getDouble("ResampleInterval") );
    	...
    	addSerializer(
    		new AbstractSerializer(UpdateDataDetails.class, UpdateDataDetails.BINARY, UpdateDataDetails.XML) {
    			public void calcEncodeable(IEncodeable encodeable, IEncoder calculator) throws EncodingException {
    				...
    				calculator.putEncodeable(null, HistoryData.class, (obj==null)?null:obj.getUpdateValue());
    			}
    			public void putEncodeable(IEncodeable encodeable, IEncoder encoder) throws EncodingException {
    				UpdateDataDetails obj = (UpdateDataDetails) encodeable;
    				encoder.putNodeId("NodeId",  (obj==null)?null:obj.getNodeId() );
    				encoder.putEnumeration("PerformInsertReplace",  (obj==null)?null:obj.getPerformInsertReplace() );
    				encoder.putEncodeable("UpdateValue", HistoryData.class, (obj==null)?null:obj.getUpdateValue());
    			}
    			public IEncodeable getEncodeable(IDecoder decoder) throws DecodingException {
    				UpdateDataDetails result = new UpdateDataDetails();
    				result.setNodeId( decoder.getNodeId("NodeId") );
    				result.setPerformInsertReplace( decoder.getEnumeration("PerformInsertReplace", HistoryUpdateMode.class) );
    				result.setUpdateValue( decoder.getEncodeable("UpdateValue", HistoryData.class) );
    				return result;
    			}
    		});
    
    	// InsertReplaceEventDetails
    	addSerializer(
    		new AbstractSerializer(InsertReplaceEventDetails.class, InsertReplaceEventDetails.BINARY, InsertReplaceEventDetails.XML) {
    			public void calcEncodeable(IEncodeable encodeable, IEncoder calculator) throws EncodingException {
    				InsertReplaceEventDetails obj = (InsertReplaceEventDetails) encodeable;
    				calculator.putNodeId(null,  (obj==null)?null:obj.getNodeId() );
    				calculator.putEnumeration(null, null /*obj.getPerformInsertReplace()*/);
    				calculator.putEncodeableArray(null, SimpleAttributeOperand.class, (obj==null)?null:obj.getSelectClause());
    			...
    			public void putEncodeable(IEncodeable encodeable, IEncoder encoder) throws EncodingException {
    				...
    				encoder.putNodeId("NodeId",  (obj==null)?null:obj.getNodeId() );
    				encoder.putEnumeration("PerformInsertReplace",  (obj==null)?null:obj.getPerformInsertReplace() );
    				encoder.putEncodeableArray("SelectClause", SimpleAttributeOperand.class, (obj==null)?null:obj.getSelectClause());
    			...
    			public IEncodeable getEncodeable(IDecoder decoder) throws DecodingException {
    				...
    				result.setNodeId( decoder.getNodeId("NodeId") );
    				result.setPerformInsertReplace( decoder.getEnumeration("PerformInsertReplace", HistoryUpdateMode.class) );
    				result.setSelectClause( decoder.getEncodeableArray("SelectClause", SimpleAttributeOperand.class) );
    	...
    	addSerializer(
    		new AbstractSerializer(UpdateEventDetails.class, UpdateEventDetails.BINARY, UpdateEventDetails.XML) {
    			public void calcEncodeable(IEncodeable encodeable, IEncoder calculator) throws EncodingException {
    				...
    				calculator.putEnumeration(null, null /*obj.getPerformInsertReplace()*/);
    				calculator.putEncodeable(null, EventFilter.class, (obj==null)?null:obj.getFilter());
    				calculator.putEncodeable(null, HistoryEventFieldList.class, (obj==null)?null:obj.getEventData());
    			}
    			public void putEncodeable(IEncodeable encodeable, IEncoder encoder) throws EncodingException {
    				UpdateEventDetails obj = (UpdateEventDetails) encodeable;
    				encoder.putNodeId("NodeId",  (obj==null)?null:obj.getNodeId() );
    				encoder.putEnumeration("PerformInsertReplace",  (obj==null)?null:obj.getPerformInsertReplace() );
    				encoder.putEncodeable("Filter", EventFilter.class, (obj==null)?null:obj.getFilter());
    				encoder.putEncodeable("EventData", HistoryEventFieldList.class, (obj==null)?null:obj.getEventData());
    			}
    			public IEncodeable getEncodeable(IDecoder decoder) throws DecodingException {
    				...
    				result.setPerformInsertReplace( decoder.getEnumeration("PerformInsertReplace", HistoryUpdateMode.class) );
    				result.setFilter( decoder.getEncodeable("Filter", EventFilter.class) );
    				result.setEventData( decoder.getEncodeable("EventData", HistoryEventFieldList.class) );
    				return result;
    			}
    		});
    	...
    	addSerializer(
    		new AbstractSerializer(DeleteEventDetails.class, DeleteEventDetails.BINARY, DeleteEventDetails.XML) {
    			public void calcEncodeable(IEncodeable encodeable, IEncoder calculator) throws EncodingException {
    				...
    				calculator.putNodeId(null,  (obj==null)?null:obj.getNodeId() );
    				calculator.putByteString(null,  (obj==null)?null:obj.getEventIds() );
    			}
    			public void putEncodeable(IEncodeable encodeable, IEncoder encoder) throws EncodingException {
    				DeleteEventDetails obj = (DeleteEventDetails) encodeable;
    				encoder.putNodeId("NodeId",  (obj==null)?null:obj.getNodeId() );
    				encoder.putByteString("EventIds",  (obj==null)?null:obj.getEventIds() );
    			}
    			public IEncodeable getEncodeable(IDecoder decoder) throws DecodingException {
    				DeleteEventDetails result = new DeleteEventDetails();
    				result.setNodeId( decoder.getNodeId("NodeId") );
    				result.setEventIds( decoder.getByteString("EventIds") );
    				return result;
    			}
    		});
    	...
    	addSerializer(
    		new AbstractSerializer(AggregateConfiguration.class, AggregateConfiguration.BINARY, AggregateConfiguration.XML) {
    			public void calcEncodeable(IEncodeable encodeable, IEncoder calculator) throws EncodingException {
    				...
    				calculator.putBoolean(null, null /*obj.getUseSeverCapabilitiesDefaults()*/);
    				...
    				calculator.putBoolean(null, null /*obj.getSteppedSlopedExtrapolation()*/);
    			}
    			public void putEncodeable(IEncodeable encodeable, IEncoder encoder) throws EncodingException {
    				AggregateConfiguration obj = (AggregateConfiguration) encodeable;
    				encoder.putBoolean("UseSeverCapabilitiesDefaults",  (obj==null)?null:obj.getUseSeverCapabilitiesDefaults() );
    				...
    				encoder.putBoolean("SteppedSlopedExtrapolation",  (obj==null)?null:obj.getSteppedSlopedExtrapolation() );
    			}
    			public IEncodeable getEncodeable(IDecoder decoder) throws DecodingException {
    				AggregateConfiguration result = new AggregateConfiguration();
    				result.setUseSeverCapabilitiesDefaults( decoder.getBoolean("UseSeverCapabilitiesDefaults") );
    				...
    				result.setSteppedSlopedExtrapolation( decoder.getBoolean("SteppedSlopedExtrapolation") );
    				return result;
    			}
    		});
    	...
    	addSerializer(
    		new AbstractSerializer(ServerDiagnosticsSummaryDataType.class, ServerDiagnosticsSummaryDataType.BINARY, ServerDiagnosticsSummaryDataType.XML) {
    			public void calcEncodeable(IEncodeable encodeable, IEncoder calculator) throws EncodingException {
    				...
    				calculator.putUInt32(null, null /*obj.getSamplingRateCount()*/);
    			...
    			public void putEncodeable(IEncodeable encodeable, IEncoder encoder) throws EncodingException {
    				...
    				encoder.putUInt32("SamplingRateCount",  (obj==null)?null:obj.getSamplingRateCount() );
    			...
    			public IEncodeable getEncodeable(IDecoder decoder) throws DecodingException {
    				...
    				result.setSamplingRateCount( decoder.getUInt32("SamplingRateCount") );
