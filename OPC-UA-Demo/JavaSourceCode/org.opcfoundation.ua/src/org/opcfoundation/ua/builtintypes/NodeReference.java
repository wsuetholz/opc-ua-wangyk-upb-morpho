...
public class NodeReference {
	...
	{
		return new NodeReference(serverTable.getRight(0), namespaceTable.getUri(nodeId.getNamespaceIndex()), nodeId.getValue());
	}
	...
	public static NodeReference createFromNodeId(ExpandedNodeId nodeId, NamespaceTable namespaceTable, ServerTable serverTable)
	{
		if (nodeId.getNamespaceUri()!=null)
			return new NodeReference(serverTable.getRight(nodeId.getServerIndex().intValue()), nodeId.getNamespaceUri(), nodeId.getValue());
		return new NodeReference(serverTable.getRight(nodeId.getServerIndex().intValue()), namespaceTable.getUri(nodeId.getNamespaceIndex()), nodeId.getValue());
	}
