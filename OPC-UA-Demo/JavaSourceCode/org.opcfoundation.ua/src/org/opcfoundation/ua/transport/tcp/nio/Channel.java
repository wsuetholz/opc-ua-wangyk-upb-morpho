 ...
 * 
 */
public interface Channel /* extends IStatefulObject<CloseableObjectState, ServiceResultException>*/ {

	void addChannelListener(MessageListener listener);
	void removeChannelListener(MessageListener listener);	
	
	public static interface ChannelListener /*extends StateListener<CloseableObjectState>*/ {
