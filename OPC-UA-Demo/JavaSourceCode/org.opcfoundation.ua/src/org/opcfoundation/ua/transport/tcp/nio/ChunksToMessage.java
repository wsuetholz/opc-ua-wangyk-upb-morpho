...
/**
 * This {@link Callable} class unserializes chunk payloads into a message. 
 * 
 */
public class ChunksToMessage implements Callable<IEncodeable> {
	 ...
	 * @param payloads
	 */
	public ChunksToMessage(TcpConnectionParameters ctx, EncoderContext encoderCtx, Class<? extends IEncodeable> expectedType, ByteBuffer...payloads)
	{
	...
	public IEncodeable call() throws Exception {
		ByteBufferArrayReadable readable = new ByteBufferArrayReadable(payloads);
