...
public class DiagnosticInfo {
     ...
     * @param result
     * @param diagnosticsMask
     * @param serviceLevel
     * @param stringTable
     */
    public DiagnosticInfo(ServiceResult result,
    		UnsignedInteger diagnosticsMask,
    		boolean serviceLevel,
    		String[] stringTable) {
    	if (!serviceLevel) {
//			TODO: diagnosticsMask >>= 6;
		}
	 ...
	 * @param diagnosticsMask
	 * 		The bitmask describing the type of diagnostic data
	 * @param stringTable
	 * 		An array of strings that may be used to provide additional diagnostic details.
	 */
	private void initialize(ServiceResult result,
			UnsignedInteger diagnosticsMask,
			String[] stringTable) {
		
		if (stringTable == null) throw new IllegalArgumentException("stringTable");
		
        symbolicId          = -1;
        namespaceUri        = -1;
        localizedText       = -1;
        additionalInfo     = null;
        innerStatusCode     = /*TODO check statuscode*/StatusCode.getFromBits(StatusCode.SEVERITY_GOOD);
        innerDiagnosticInfo = null;
		
        // TODO: does not really initialize anything...
	}
