...
public class ListenableSocketChannel {
	...
	/**
	 * Create new async-socket with on-demand event handling thread 
	 * @throws IOException
	 */
	public ListenableSocketChannel() 
	throws IOException {
		this(
...
//			Executors.newFixedThreadPool(1),
	...
	/**
	 * Create async-socket wrapper over given socket channel with on-demand listener
	 * handling thread. 
	 * @param channel
	 * @throws IOException
	 */
	...
	throws IOException {
		this(
		        ...
		        new ThreadPoolExecutor(
	                    ...
	                    60L, TimeUnit.SECONDS,
	                    new LinkedBlockingQueue<Runnable>(),
	                    StackUtils.newNamedThreadFactory("listen3"))
			);
	}
