...
\lhead{}
\chead{}
\rhead{Leveraging OPC UA Standards with Smart Card Technology for Secure Applications and Services}
\lfoot{}
\cfoot{}
\rfoot{\thepage}
...
\usepackage{enumitem}
\begin{document}
\title{Leveraging Object Linking and Embedding for Processes Control Unified Architecture Standards with Smart Card Technology for Secure Applications and Services} %titles have no end punctuation
